...
public class ExpertThreePlayerStrategy extends ThreePlayerStrategy{
    ...
    public List<SchoolBoard> initializeSchoolBoards(StudentFactory studentFactory) throws EmptyStudentSupplyException {
        ...
        schoolBoards.add(
                new ExpertSchoolBoard(2, studentFactory.getNStudents(this.numberOfStudentsInTheEntrance), TowerColor.GRAY,1)
        );
        return schoolBoards;
    }
}
